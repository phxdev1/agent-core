...
# Our systems
from unified_memory_system import get_unified_memory, StepType
from context_intelligence_system import get_context_intelligence
from knowledge_graph_enhanced import get_enhanced_knowledge_graph
from adaptive_personality_system import get_personality_system
from hybrid_search_system import get_search_system
from research_system import ResearchSystem
from temporal_context import get_temporal_context, TimeGranularity
from redis_logger import get_redis_logger
from prompt_evolution_system import get_prompt_evolution_system
...
class ChatAgent:
    ...
    def __init__(self):
        ...
        self.model = 'mistralai/mistral-medium-3.1'  # Temporarily back to Mistral
        
        # Initialize ALL our sophisticated systems
        self.memory = get_unified_memory()  # Tape-based memory with sliding windows
        self.context = get_context_intelligence()  # Deep psychological understanding
        self.knowledge = get_enhanced_knowledge_graph()  # Entity/relationship tracking
        self.personality = get_personality_system()  # Adaptive Nick Offerman personality
        self.search = get_search_system()  # Hybrid BM25 + vector search
        self.research = ResearchSystem()  # Full research capabilities
        self.temporal = get_temporal_context()  # Temporal awareness and scheduling
        self.prompt_evolution = get_prompt_evolution_system()  # Dynamic prompt management
